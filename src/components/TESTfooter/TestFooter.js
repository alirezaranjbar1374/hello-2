...
<div className="pg-footer">
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name"> همکاری با ما</h2>
            <ul id="menu-company" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">مدرسین</a>
              </li>
              <li className="menu-item menu-item-type-taxonomy menu-item-object-category">
                <a href="#">کلاس های حضوری</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">رفع اشکال آنلاین</a>
              </li>
            </ul>
          </div>
          <div className="footer-menu">
            <h2 className="footer-menu-name"> کلاس های حضوری</h2>
            <ul id="menu-legal" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-170434">
                <a href="#">کلاس آنلاین</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#">درخواست تشکیل کلاس</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> درباره ما</h2>
            <a href=''>  
                      <h2 className="footer-call-to-action-description"> آدرس</h2>
</a>
            <a className="footer-call-to-action-button button" href="#" target="_self">پشتیبانی واتساپ</a>
          </div>
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> شماره پشتیبانی</h2>
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self">02155645491 </a></p>
          </div>
        </div>
